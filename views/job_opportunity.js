...
<html lang="en">
 ...
 <head> <meta name="viewport" content="width=device-width, initial-scale=1" />
  ...
  <title>POLO | The Multi-Purpose HTML5 Template</title> <!-- Stylesheets & Fonts -->
...
<div class="col-md-2-5 p-l-0">
    ...
    <section>
      <div class="container">
        ...
        <!--Default Form-->
        <div class="hr-title hr-long center"><abbr>Grey fields Form</abbr> </div>
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <form class="form-gray-fields">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="upper" for="name">Your Name</label>
                    <input type="text" class="form-control required" name="senderName" placeholder="Enter name" id="name3" aria-required="true">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="upper" for="email">Your Email</label>
                    <input type="email" class="form-control required email" name="senderEmail" placeholder="Enter email" id="email3" aria-required="true">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="upper" for="phone">Your Phone</label>
                    <input type="text" class="form-control required" name="phone" placeholder="Enter phone" id="phone3" aria-required="true">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="upper" for="company">Your Company</label>
                    <input type="text" class="form-control required" name="company" placeholder="Enter company" id="company3" aria-required="true">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="upper" for="comment">Your comment</label>
                    <textarea class="form-control required" name="comment" rows="9" placeholder="Enter comment" id="comment3" aria-required="true"></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
        ...
        <!--Form inline-->
        <div class="hr-title hr-long center"><abbr>Form inline</abbr> </div>
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
        ...
        <!--Form inline-->
        <div class="hr-title hr-long center"><abbr>Send invitation example</abbr> </div>
        <div class="row">
          <div class="col-md-8 col-md-offset-2 center">
            <form class="form-inline">
              <div class="form-group">
                <label for="exampleInputName2" class="text-left">Name</label>
                <input type="text" class="form-control" id="exampleInputName2" placeholder="Jane Doe">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail2" class="text-left">Email</label>
                <input type="email" class="form-control" id="exampleInputEmail2" placeholder="jane.doe@example.com">
              </div>
              <div class="form-group">
                <button class="m-t-35 btn btn-default" type="submit">Send invitation</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <!--Form inline-->
        <div class="hr-title hr-long center"><abbr>Checkboxes & Selects</abbr> </div>
        <div class="row">
          <div class="col-md-6">
            <div class="checkbox">
              <label>
            ...
            <div class="checkbox disabled">
              <label>
                <input type="checkbox" value="" disabled> Option two is disabled </label>
            </div>
            <div class="radio">
              <label>
            ...
            <div class="radio disabled">
              <label>
                <input type="radio" name="optionsRadios" id="optionsRadios3" value="option3" disabled> Option three is disabled </label>
            </div>
          </div>
          <div class="col-md-6">
            <select>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 center">
            ...
            <div class="form-group has-warning has-feedback">
              ...
              <span class="fa fa-info-circle form-control-feedback" aria-hidden="true"></span> <span id="inputWarning2Status" class="sr-only">(warning)</span> </div>
    ...
    <section class="parallax text-light background-overlay" style="background: url('images/parallax/15.jpg');" >
      <div class="container">
        <div class="text-center text-light">
          <hr class="space">
          <h1 class="heading-jumbo">Transparent form</h1>
          ...
          <form class="form-transparent-fields">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="upper" for="name">Your Name</label>
                  <input type="text" class="form-control required" name="senderName" placeholder="Enter name" id="name2" aria-required="true">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="upper" for="email">Your Email</label>
                  <input type="email" class="form-control required email" name="senderEmail" placeholder="Enter email" id="email2" aria-required="true">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label class="upper" for="phone">Your Phone</label>
                  <input type="text" class="form-control required" name="phone" placeholder="Enter phone" id="phone2" aria-required="true">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="upper" for="company">Your Company</label>
                  <input type="text" class="form-control required" name="company" placeholder="Enter company" id="company2" aria-required="true">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="upper" for="comment">Your comment</label>
                  <textarea class="form-control required" name="comment" rows="9" placeholder="Enter comment" id="comment2" aria-required="true"></textarea>
                </div>
              </div>
            </div>
            <div class="row">
...
<!--Template functions-->
 <script src="javascripts/functions.js"></script> </body>
